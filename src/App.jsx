...
const EngineeringPortfolio = () => {
  ...
  return (
    <div className="min-h-screen transition-all duration-1000 relative bg-bg-main text-content-main overflow-x-hidden selection:bg-accent/30">
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
        <div className="container mx-auto max-w-[1600px] px-6 md:px-20 relative z-10">
          ...
          >
            ...
            <p className="max-w-2xl text-content-alt text-lg md:text-2xl font-medium leading-relaxed mb-10 md:mb-16">
        ...
        <div className="container mx-auto max-w-[1600px] px-6 lg:px-20">
          <div className="grid lg:grid-cols-2 gap-16 lg:grid-cols-2 lg:gap-32 items-center">
            <div className="relative">
              ...
              <div className="space-y-6 md:space-y-10 text-lg md:text-xl text-content-alt font-medium max-w-lg leading-relaxed">
                <p>
            ...
            {projects.map((proj, i) => (
              ...
              >
                <div className="hud-border hud-border-tl hud-border-tr hud-border-bl hud-border-br p-6 md:p-10 glass-morphism h-full flex flex-col hover:border-accent hover:shadow-[0_0_30px_rgba(var(--accent-rgb),0.1)] transition-all duration-500 overflow-hidden bg-accent/2">
                  ...
                  <p className="text-content-alt font-medium leading-relaxed mb-10 flex-grow text-sm">{proj.desc}</p>
